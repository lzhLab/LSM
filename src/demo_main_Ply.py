...
for image_dir, label_dir, mask_dir in tqdm(zip(imgs_dir, labels_dir, masks_dir)):
    am.copysmallobjects2_Ply(image_dir, label_dir, mask_dir, save_base_dir, save_mask_dir, enlarge, paste_number, dtype)
    #break
