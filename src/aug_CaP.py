...
#oricp
def copysmallobjects2_CaP(image_dir, label_dir, mask_dir, save_base_dir, save_mask_dir, enlarge, paste_number):
...
def copysmallobjects2_Rotation(image_dir, label_dir, mask_dir, save_base_dir, save_mask_dir, enlarge, paste_number):
